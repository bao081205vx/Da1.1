...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Trang chủ"},
        {"Sản Phẩm"},
        {"Thuộc Tính", "Chất liệu", "Xuất sứ", "Kích thước", "Màu Sắc", "Nhà cung cấp"},
        {"Đơn Hàng"},
        {"Voucher"},
        {"Kho Hàng"},
        {"Nhân Viên"},
        {"Thống kê", "Doanh thu 1 ngày", "Doanh thu 7 ngày gần nhất", "Doanh thu 1 tháng gần nhất", "Doanh thu 6 tháng gần nhất", "Doanh thu 1 năm"},
        {"Thông tin cá nhân"},
        {"Logout"}
    };
    ...
    private final String headerName = "Tên User";
